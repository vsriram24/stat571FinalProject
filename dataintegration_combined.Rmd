...
newHappiness_filtered = newHappiness %>%
  select(-basicHandwashing, -malariaPer1kAtRisk, -ModernFamilyPlanningPercent,  -PopPercentSanitationServices)
...
# EDA
```{r}
plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$Economy..GDP.per.Capita., ylab = "Happiness Score", xlab = "GDP per Capita")
...
plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$Family, ylab = "Happiness Score", xlab = "Family")
text(newHappiness_filtered$Family~newHappiness_filtered$Happiness.Score, labels = newHappiness_filtered$Location)

plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$Health..Life.Expectancy., ylab = "Happiness Score", xlab = "Life Expectancy")
...
plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$Freedom, ylab = "Happiness Score", xlab = "Freedom")
text(newHappiness_filtered$Freedom~newHappiness_filtered$Happiness.Score, labels = newHappiness_filtered$Location)

plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$Generosity, ylab = "Happiness Score", xlab = "Generosity")
text(newHappiness_filtered$Generosity~newHappiness_filtered$Happiness.Score, labels = newHappiness_filtered$Location)

plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$Trust..Government.Corruption., ylab = "Happiness Score", xlab = "Government Corruption Trust")
...
plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$probOfDyingFromDisease, ylab = "Happiness Score", xlab = "Probability of Dying from Disease")
...
plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$adolescentBirthRate, ylab = "Happiness Score", xlab = "Adolescent Birth Rate")
...
plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$alcoholSubstanceAbuse, ylab = "Happiness Score", xlab = "Alcohol Substance Abuse")
...
plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$basicSanitizationServices, ylab = "Happiness Score", xlab = "Basic Sanitization Services")
...
plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$birthsAttendedBySkilledPersonal, ylab = "Happiness Score", xlab = "Births Attended by Skilled Personal")
...
plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$cleanFuelAndTech, ylab = "Happiness Score", xlab = "Clean Fuel and Tech")
text(newHappiness_filtered$cleanFuelAndTech~newHappiness_filtered$Happiness.Score, labels = newHappiness_filtered$Location)

plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$dentistsAvailable, ylab = "Happiness Score", xlab = "Dentists Available")
text(newHappiness_filtered$dentistsAvailable~newHappiness_filtered$Happiness.Score, labels = newHappiness_filtered$Location)

plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$suicideRates, ylab = "Happiness Score", xlab = "Suicide Rates")
text(newHappiness_filtered$suicideRates~newHappiness_filtered$Happiness.Score, labels = newHappiness_filtered$Location)

plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$healthyLifeExpectancy, ylab = "Happiness Score", xlab = "Healthy Life Expectancy")
...
plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$hepBAntigenPrev, ylab = "Happiness Score", xlab = "Hep B Antigen Prevalence")
text(newHappiness_filtered$hepBAntigenPrev~newHappiness_filtered$Happiness.Score, labels = newHappiness_filtered$Location)

plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$tbPer100k, ylab = "Happiness Score", xlab = "Tuberculosis per 100k")
text(newHappiness_filtered$tbPer100k~newHappiness_filtered$Happiness.Score, labels = newHappiness_filtered$Location)

plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$infantMortalityPer1k, ylab = "Happiness Score", xlab = "Infant Mortality per 1k")
...
plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$NTDIntervention, ylab = "Happiness Score", xlab = "NTD Intervention")
text(newHappiness_filtered$NTDIntervention~newHappiness_filtered$Happiness.Score, labels = newHappiness_filtered$Location)

plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$lifeExpectancy, ylab = "Happiness Score", xlab = "Life Expectancy")
text(newHappiness_filtered$lifeExpectancy~newHappiness_filtered$Happiness.Score, labels = newHappiness_filtered$Location)

plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$maternalMortalityPer100k, ylab = "Happiness Score", xlab = "Maternal Mortality per 100k")
...
plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$DoctorsPer10k, ylab = "Happiness Score", xlab = "Doctors Perk 10k")
text(newHappiness_filtered$DoctorsPer10k~newHappiness_filtered$Happiness.Score, labels = newHappiness_filtered$Location)

plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$mortalityRatePoisoningPer100k, ylab = "Happiness Score", xlab = "Mortality Rate Poisoning per 100k")
...
plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$mortalityRateUnsafeWashPer100k, ylab = "Happiness Score", xlab = "Mortality Rate Unsafe Washing per 100k")
...
plot(newHappiness_filtered$Happiness.Score, newHappiness_filtered$neonatalMortalityPer1k, ylab = "Happiness Score", xlab = "Neonatal Mortality per 1k")
...
# Regression
```{r}
data.happiness <- as.data.frame(na.omit(newHappiness_filtered))
Y <- data.happiness[, 3]
